...
{
    /// <inheritdoc />
    public partial class AddWorkManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockerReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkUpdates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkUpdates_WorkItems_WorkItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkItems_AssignedToId_Status_DueDate",
                table: "WorkItems",
                columns: new[] { "AssignedToId", "Status", "DueDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkUpdates_CreatedById",
                table: "WorkUpdates",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_WorkUpdates_WorkItemId_CreatedAt",
                table: "WorkUpdates",
